...
Each page covers one task or concept. Choose the path that matches your role.
...
- [Understand database storage](admin/database-storage.md)
- [Operate Docker](admin/docker-operations.md)
- [Troubleshoot the system](admin/troubleshooting.md)
- [Recover from a failed update](admin/recovery.md)

## Developer

- [Set up a development environment](developer/setup.md)
