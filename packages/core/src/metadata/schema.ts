...
const artifactSchemas = [
  ...
  Type.Object({ kind: Type.Literal('formExtension'), ...common, form: Type.String(), listFields: Type.Optional(Type.Array(Type.String())), groups: Type.Optional(Type.Array(groupSchema)) }, { additionalProperties: false }),
