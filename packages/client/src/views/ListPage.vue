...
<style scoped>
.list-heading{display:flex;justify-content:space-between;gap:16px;align-items:start;margin-bottom:22px}.list-heading h1{margin:0;font-size:30px;letter-spacing:-.04em}.list-heading p{margin:5px 0;color:var(--emu-muted)}.list-tools{display:grid;grid-template-columns:minmax(150px,220px) minmax(220px,420px) auto auto;gap:8px;margin-bottom:16px;padding:12px;background:#fff;border:1px solid var(--emu-border);border-radius:var(--emu-radius-lg);box-shadow:var(--emu-shadow-sm)}.list-table{border:1px solid var(--emu-border);border-radius:var(--emu-radius-lg);overflow:hidden;box-shadow:var(--emu-shadow-sm)}.list-empty{padding:70px 0;background:#fff;border:1px dashed var(--emu-border);border-radius:var(--emu-radius-lg)}@media(max-width:700px){.list-heading{display:block}.list-heading h1{font-size:24px;overflow-wrap:anywhere}.list-heading>.n-space{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr));margin-top:12px}.list-heading>.n-space :deep(.n-button){width:100%;min-height:44px}.list-tools{grid-template-columns:1fr}.list-tools :deep(.n-button){min-height:44px}.list-table :deep(.n-data-table__pagination){overflow-x:auto;justify-content:flex-start}.list-table :deep(.n-pagination-item){min-width:40px;min-height:40px}}
</style>
